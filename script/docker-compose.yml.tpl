...
cat > $${adirScript}/docker-compose.yml <<"EOFDC"
version: "3"
...
#      - POSTGRES_DB=mattermost
  ...
  app:
    ...
    environment:
      ...
      - MM_SQLSETTINGS_DATASOURCE=mysql://mmuser:${db_password}@tcp(${db_host}:3306)/mattermost?sslmode=disable&connect_timeout=10
